...
if __name__ == '__main__' :
    quiz2 = quiz("localhost", "3306", "root", "")
    quiz2.create_db("student3")
    df = quiz2.import_csv(r"C:\Users\Acer\PycharmProjects\pythonProject\venv\sample.csv")
    quiz2.create_table("student3","sample",df)
    print(quiz2.load_data("student3","sample"))